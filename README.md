...
2. 选择当前博客仓库 `FangchenKang/fangchenkang.github.io`。
...
当前仓库发布在 `FangchenKang` 账号下，仓库名为 `fangchenkang.github.io`，因此 GitHub Pages 地址是 `https://fangchenkang.github.io/`。本项目提供 GitHub Actions 工作流，通过 Actions 构建 Hexo 并发布 `public/` 到 GitHub Pages。
